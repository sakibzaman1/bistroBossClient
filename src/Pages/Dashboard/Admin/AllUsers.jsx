                ...
                <td>
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <div className="text-sm opacity-50 bg-amber-600 p-2 rounded-full text-white">{user.role === 'admin'? 'Admin' : <button onClick={()=> handleMakeAdmin(user)}>Make Admin</button>}</div>
                    </div>
                  </div>
                </td>
